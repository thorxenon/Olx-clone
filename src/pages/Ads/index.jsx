        ...
        <PageContainer>
            <PageArea>
                    ...
                    <form method="GET">
                        ...
                        <ul>
                            {categories.map((i,k)=>
                                <li
                                key={k}
                                className={cat==i.slug ? 'category-item active':'category-item'}
                ...
                <div className="right-side">
                    ...
                    {!loading && adList.length === 0 &&
                        <div className="list-warning">Não encontramos resultados!</div>
                    }
                    ...
                    <div className="pagination">
                        {pagination.map((i,k)=>
                            <div onClick={()=>setCurrentPage(i)} className={i===currentPage?"page-item active" : "page-item"}>{i}</div>
                        )}
                    </div>
                </div>
            </PageArea>
